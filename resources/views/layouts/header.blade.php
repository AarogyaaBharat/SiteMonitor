    ...
    <nav class="border-b border-gray-200 dark:border-gray-700 px-4 py-3 sticky top-0 z-50 bg-[var(--bg)]">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center space-x-2">
                <a href="{{ url('/') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-[var(--primary)]" viewBox="0 0 20 20"
                        fill="currentColor">
                ...
                <a href="{{ url('/') }}">
                    <span
                        class="font-bold text-xl bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] inline-block text-transparent bg-clip-text">SiteMonitor</span>
                </a>
            </div>
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="{{ url('/') }}"
                    class="text-[var(--text)] hover:text-[var(--primary)] transition-colors">Home</a>
                <div class="relative group" id="features-dropdown">
                    <a href="#"
                        class="text-[var(--text)] hover:text-[var(--primary)] transition-colors flex items-center">
                        Features
                    ...
                    <div class="absolute left-0 mt-2 w-48 bg-[var(--bg)] border border-gray-200 rounded-lg shadow-lg opacity-0 invisible transition-all duration-200 z-50"
                        id="features-menu">
                        <a href="{{ route('check-urls-regx') }}"
                            class="block px-4 py-2 text-[var(--text)] hover:bg-[var(--primary)] hover:text-white rounded-t-lg transition-colors">Regex
                            Check</a>
                        <a href="{{ route('check-page-speed') }}"
                            class="block px-4 py-2 text-[var(--text)] hover:bg-[var(--primary)] hover:text-white transition-colors">Performance
                            Reports</a>
                        <a href="#"
                            class="block px-4 py-2 text-[var(--text)] hover:bg-[var(--primary)] hover:text-white rounded-b-lg transition-colors">BackLink
                            Finder</a>
                    </div>
                </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        toggle.addEventListener('click', function(e) {
                            ...
                            document.querySelectorAll('.absolute.opacity-100').forEach(el => {
                                if (el !== menu) {
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu"
            class="mobile-menu fixed inset-0 bg-[var(--bg)] z-50 transform translate-x-full md:hidden">
            ...
            <div class="flex flex-col items-center space-y-6 mt-10">
                <a href="{{ url('/') }}"
                    class="text-[var(--text)] hover:text-[var(--primary)] transition-colors text-lg">Home</a>
                <div class="relative group w-full flex flex-col items-center">
                    <a href="#"
                        class="text-[var(--text)] hover:text-[var(--primary)] transition-colors text-lg flex items-center justify-center">
                        Features
                        <svg class="ml-1 w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                    ...
                    <div
                        class="absolute left-1/2 transform -translate-x-1/2 mt-2 w-56 bg-[var(--bg)] border border-gray-200 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity z-50">
                        <a href="{{ route('check-urls-regx') }}"
                            class="block px-4 py-2 text-[var(--text)] hover:bg-[var(--primary)] hover:text-white rounded-t-lg transition-colors">Regex
                            Check</a>
                        <a href="{{ route('check-page-speed') }}"
                ...
                <a href="#"
                    class="text-[var(--text)] hover:text-[var(--primary)] transition-colors text-lg">About</a>
